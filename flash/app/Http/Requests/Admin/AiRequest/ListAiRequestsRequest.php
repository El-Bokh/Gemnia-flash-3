...
class ListAiRequestsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'type'            => ['sometimes', 'string', 'in:text_to_image,image_to_image,inpainting,upscale,chat,styled_chat,multimodal,regenerate,product,text_to_video,image_to_video,other'],
