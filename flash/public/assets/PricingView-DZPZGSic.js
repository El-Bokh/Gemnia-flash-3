...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function X(e,t){if(e){if(typeof e==`string`)return Z(e,t);var n={}.toString.call(e).slice(8,-1);return n===`Object`&&e.constructor&&(n=e.constructor.name),n===`Map`||n===`Set`?Array.from(e):n===`Arguments`||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)?Z(e,t):void 0}}function ie(e){if(typeof Symbol<`u`&&e[Symbol.iterator]!=null||e[`@@iterator`]!=null)return Array.from(e)}function ae(e){if(Array.isArray(e))return Z(e)}function Z(e,t){(t==null||t>e.length)&&(t=e.length);for(var n=0,r=Array(t);n<t;n++)r[n]=e[n];return r}var Q={name:`SelectButton`,extends:K,inheritAttrs:!1,emits:[`change`],methods:{getOptionLabel:function(e){return this.optionLabel?O(e,this.optionLabel):e},getOptionValue:function(e){return this.optionValue?O(e,this.optionValue):e},getOptionRenderKey:function(e){return this.dataKey?O(e,this.dataKey):this.getOptionLabel(e)},isOptionDisabled:function(e){return this.optionDisabled?O(e,this.optionDisabled):!1},isOptionReadonly:function(e){if(this.allowEmpty)return!1;var t=this.isSelected(e);return this.multiple?t&&this.d_value.length===1:t},onOptionSelect:function(e,t,n){var r=this;if(!(this.disabled||this.isOptionDisabled(t)||this.isOptionReadonly(t))){var i=this.isSelected(t),a=this.getOptionValue(t),o;if(this.multiple)if(i){if(o=this.d_value.filter(function(e){return!E(e,a,r.equalityKey)}),!this.allowEmpty&&o.length===0)return}else o=this.d_value?[].concat(J(this.d_value),[a]):[a];else{if(i&&!this.allowEmpty)return;o=i?null:a}this.writeValue(o,e),this.$emit(`change`,{originalEvent:e,value:o})}},isSelected:function(e){var t=!1,n=this.getOptionValue(e);if(this.multiple){if(this.d_value){var r=q(this.d_value),i;try{for(r.s();!(i=r.n()).done;){var a=i.value;if(E(a,n,this.equalityKey)){t=!0;break}}}catch(e){r.e(e)}finally{r.f()}}}else t=E(this.d_value,n,this.equalityKey);return t}},computed:{equalityKey:function(){return this.optionValue?null:this.dataKey},dataP:function(){return A({invalid:this.$invalid})}},directives:{ripple:k},components:{ToggleButton:V}},oe=[`aria-labelledby`,`data-p`];function se(e,t,c,u,d,f){var p=a(`ToggleButton`);return s(),m(`div`,l({class:e.cx(`root`),role:`group`,"aria-labelledby":e.ariaLabelledby},e.ptmi(`root`),{"data-p":f.dataP}),[(s(!0),m(h,null,n(e.options,function(t,n){return s(),S(p,{key:f.getOptionRenderKey(t),modelValue:f.isSelected(t),onLabel:f.getOptionLabel(t),offLabel:f.getOptionLabel(t),disabled:e.disabled||f.isOptionDisabled(t),unstyled:e.unstyled,size:e.size,readonly:f.isOptionReadonly(t),onChange:function(e){return f.onOptionSelect(e,t,n)},pt:e.ptm(`pcToggleButton`)},b({_:2},[e.$slots.option?{name:`default`,fn:i(function(){return[r(e.$slots,`option`,{option:t,index:n},function(){return[y(`span`,l({ref_for:!0},e.ptm(`pcToggleButton`).label),o(f.getOptionLabel(t)),17)]})]}),key:`0`}:void 0]),1032,[`modelValue`,`onLabel`,`offLabel`,`disabled`,`unstyled`,`size`,`readonly`,`onChange`,`pt`])}),128))],16,oe)}Q.render=se;function ce(){return M(`/plans/public`)}function le(e,t){return j(`/subscription/upgrade`,{plan_id:e,billing_cycle:t})}var ue={class:`pricing-page`},de={class:`pricing-header`},fe={class:`pricing-title`},pe={class:`pricing-sub`},me={class:`cycle-toggle`},he={key:0,class:`save-badge`},ge={key:0,class:`loading-state`},_e={key:1,class:`plans-grid`},ve={key:0,class:`popular-badge`},ye={key:1,class:`current-badge`},be={class:`plan-head`},$={class:`plan-desc`},xe={class:`plan-price`},Se={class:`price-amount`},Ce={class:`price-period`},we={class:`plan-credits`},Te={class:`credits-amount`},Ee={class:`credits-label`},De={class:`plan-features`},Oe={class:`pricing-footer`},ke=x(w({__name:`PricingView`,setup(r){let{t:i}=te(),a=e(),c=N();ne({title:f(()=>i(`seo.pricingTitle`)),description:f(()=>i(`seo.pricingDescription`)),path:`/pricing`,jsonLd:{"@context":`https://schema.org`,"@type":`WebPage`,name:`Plans & Pricing - Klek AI`,url:`https://klek.studio/pricing`,description:`Choose the perfect Klek AI plan for your creative needs.`,isPartOf:{"@type":`WebSite`,name:`Klek AI`,url:`https://klek.studio`}}});let l=g(!0),u=g(null),b=g(`monthly`),x=g([]),S=f(()=>[{label:i(`client.monthly`),value:`monthly`},{label:i(`client.yearly`),value:`yearly`}]),w={free:`#64748b`,starter:`#0ea5e9`,pro:`#8b5cf6`,professional:`#8b5cf6`,enterprise:`#f59e0b`},T=f(()=>(x.value??[]).map(e=>({id:e.id,name:e.name,slug:e.slug,price:b.value===`yearly`?e.price_yearly:e.price_monthly,credits:b.value===`yearly`?e.credits_yearly:e.credits_monthly,currency:e.currency??`USD`,description:e.description??``,is_free:e.is_free,is_featured:e.is_featured,features:(e.features??[]).map(e=>e.name),tone:w[e.slug]??`#64748b`,isCurrent:c.isAuthenticated&&c.quota?.plan_slug===e.slug})));t(async()=>{try{x.value=(await ce()).data??[]}catch{x.value=[]}finally{l.value=!1}});async function E(e){if(!c.isAuthenticated){a.push({name:`login`});return}if(!(e.isCurrent||e.is_free)){u.value=e.id;try{await le(e.id,b.value),await c.refreshQuota()}catch{}finally{u.value=null}}}return(e,t)=>(s(),m(`div`,ue,[y(`div`,de,[y(`h1`,fe,o(C(i)(`client.pricingTitle`)),1),y(`p`,pe,o(C(i)(`client.pricingSub`)),1),y(`div`,me,[d(C(Q),{modelValue:b.value,"onUpdate:modelValue":t[0]||=e=>b.value=e,options:S.value,optionLabel:`label`,optionValue:`value`,allowEmpty:!1},null,8,[`modelValue`,`options`]),b.value===`yearly`?(s(),m(`span`,he,o(C(i)(`client.save20`)),1)):p(``,!0)])]),l.value?(s(),m(`div`,ge,[...t[1]||=[y(`i`,{class:`pi pi-spin pi-spinner`,style:{"font-size":`2rem`,color:`var(--text-muted)`}},null,-1)]])):(s(),m(`div`,_e,[(s(!0),m(h,null,n(T.value,e=>(s(),m(`article`,{key:e.slug,class:v([`plan-card`,{popular:e.is_featured,current:e.isCurrent}])},[e.is_featured?(s(),m(`div`,ve,[d(C(F),{value:C(i)(`client.mostPopular`),severity:`contrast`,class:`pop-tag`},null,8,[`value`])])):p(``,!0),e.isCurrent?(s(),m(`div`,ye,[d(C(F),{value:C(i)(`client.currentPlan`),severity:`success`,class:`pop-tag`},null,8,[`value`])])):p(``,!0),y(`div`,be,[y(`h3`,{class:`plan-name`,style:_({color:e.tone})},o(e.name),5),y(`p`,$,o(e.description),1)]),y(`div`,xe,[y(`span`,Se,`$`+o(e.price),1),y(`span`,Ce,`/ `+o(b.value===`yearly`?C(i)(`client.perYear`):C(i)(`client.perMonth`)),1)]),y(`div`,we,[y(`span`,Te,o(e.credits?.toLocaleString()),1),y(`span`,Ee,o(C(i)(`client.credits`)),1)]),y(`ul`,De,[(s(!0),m(h,null,n(e.features,(t,n)=>(s(),m(`li`,{key:n,class:`feature-item`},[y(`i`,{class:`pi pi-check-circle feature-check`,style:_({color:e.tone})},null,4),y(`span`,null,o(t),1)]))),128))]),d(C(ee),{label:e.isCurrent?C(i)(`client.currentPlan`):e.is_free?C(i)(`client.startFree`):C(i)(`client.subscribe`),outlined:!e.is_featured,severity:e.is_featured?void 0:`secondary`,disabled:e.isCurrent||u.value!==null,loading:u.value===e.id,size:`small`,class:`plan-cta`,onClick:t=>E(e)},null,8,[`label`,`outlined`,`severity`,`disabled`,`loading`,`onClick`])],2))),128))])),y(`div`,Oe,[y(`p`,null,o(C(i)(`client.pricingFooter`)),1)])]))}}),[[`__scopeId`,`data-v-13e0fd1f`]]);export{ke as default};